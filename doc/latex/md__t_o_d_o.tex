Cette liste pourra vous guider dans le choix des étapes de refactoring en présentant les refactoring majeurs à faire sur le code.\hypertarget{md__t_o_d_o_autotoc_md5}{}\doxysection{Rendre la liste chaînée compatible avec les appels du vector}\label{md__t_o_d_o_autotoc_md5}
...
\end{DoxyItemize}\hypertarget{md__t_o_d_o_autotoc_md6}{}\doxysection{Utilisation d\textquotesingle{}un manager pour les ressources}\label{md__t_o_d_o_autotoc_md6}
Le manager est responsable de créer des objets, et de gérer leur cycle de vie. Le manager peut notamment avoir plusieurs factory pour les différents rôles (sources de données, type de stockage, sortie, type de calcul à effectuer)\hypertarget{md__t_o_d_o_autotoc_md7}{}\doxysection{Injection de dépendances}\label{md__t_o_d_o_autotoc_md7}
...
\DoxyCodeLine{    \mbox{\hyperlink{classstorage__type}{storage\_type}} compute\_result = \mbox{\hyperlink{classaverage}{average}}(storage); \textcolor{comment}{// change function name to change behaviour}}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classwriter}{writer}} \{ \textcolor{comment}{// pure virtual}}
...
\DoxyCodeLine{    \mbox{\hyperlink{classwriter}{writer}} *\_writer;}
\DoxyCodeLine{    }
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{    \mbox{\hyperlink{classprocess_a86eb2d6e61399e58e85d4e42974d3b6b}{process}}(\mbox{\hyperlink{classstorage__type}{storage\_type}} *stor, \mbox{\hyperlink{classloader}{loader}} *load, \mbox{\hyperlink{classcalculation}{calculation}} *calc, \mbox{\hyperlink{classwriter}{writer}} *write);}
\DoxyCodeLine{    \textcolor{keywordtype}{void} \mbox{\hyperlink{classprocess_a86db3fe5f9bd3f55d39ca6957bd25281}{execute}}();}
\DoxyCodeLine{\};}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classprocess_a86db3fe5f9bd3f55d39ca6957bd25281}{process::execute}}() \{}
\DoxyCodeLine{    \textcolor{comment}{// /!\(\backslash\) Think of checking for nullptr first}}
\DoxyCodeLine{    *\_storage = \_loader-\/>load(path\_to\_file);}
\DoxyCodeLine{    \_calc-\/>compute(\_storage);}
\DoxyCodeLine{    \_writer-\/>write(\_storage);}
\DoxyCodeLine{\}}
...
\DoxyCodeLine{    p.\mbox{\hyperlink{classprocess_a86db3fe5f9bd3f55d39ca6957bd25281}{execute}}();}
